...
public class AnimatorActivity extends BaseActivity {
    ...
    public void scale() {
        ObjectAnimator animator = ObjectAnimator.ofFloat(tv, "scaleX", 0, 3, 1, 2, 5,1);
        animator.setDuration(2000);
        animator.start();
    ...
    public void color() {
        ObjectAnimator animator = ObjectAnimator.ofInt(tv, "BackgroundColor", 0xffff00ff,0xffff00ff);
    ...
    public void charFAnim() {
        // ObjectAnimator animator = ObjectAnimator.ofFloat(tv, "scaleX", 0, 3, 1, 2, 5);
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
           ...
           // @Override
            //public void onAnimationUpdate(ValueAnimator animation)	{
              //  char text= (char) animation.getAnimationValue();
                //tv.setText(String.valueOf(text));
            //}
        //});
    ...
    private ValueAnimator doAnimatorListener() {
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationCancel(Animator animation) {
                ...
                UtilLog.d("shreya", "animation Cancelled");
            ...
            public void onAnimationRepeat(Animator animation) {
                shortToast("Repeated");
                UtilLog.d("shreya", "animation Repeated");
